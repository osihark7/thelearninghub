...
import com.dreamsathis.entity.PaymentAccount;
...
public class BlogController extends BaseController {
	...
	@PostMapping("/payment")
	public String pyment(@ModelAttribute PaymentAccount account) throws RazorpayException {
		RazorpayClient razorpayClient = new RazorpayClient(keyId,secret);
		JSONObject options = new JSONObject();
		options.put("amount", account.getAmount()*100);
